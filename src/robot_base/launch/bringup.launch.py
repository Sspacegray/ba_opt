...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="false",
            description="Enable tilt_compensator node (default: false)",
        )
    )
    ...
    enable_tilt_compensator = LaunchConfiguration("enable_tilt_compensator")
    ...
    nodes_list = [
        Node(
            ...
            Node(
                ...
                condition=IfCondition(enable_tilt_compensator),
            ),
    ]
