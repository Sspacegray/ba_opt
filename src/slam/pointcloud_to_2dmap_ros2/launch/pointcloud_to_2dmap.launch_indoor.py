...
def generate_launch_description():
    ...
    input_pcd = "/home/wz/ros2_test_ws/src/pointcloud_to_2dmap_ros2/map/map.pcd"
    ...
    return LaunchDescription([
        Node(
            ...
            parameters=[{
                ...
                'min_points_in_pix': 5,  # 一个像素点上最少需要累积多少点云点才认为有效，用于过滤稀疏点
                'max_points_in_pix': 10,  # 一个像素点上最多累积多少点云点，超过会映射到最大灰度值，用于归一化
                'min_height': 0.5,   # 只保留高度大于该值的点（米），用于去掉地面以下或低矮噪声点
